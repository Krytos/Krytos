...
**Senior Python Backend Engineer | Python · FastAPI · CI/CD · Azure**

<a href="https://www.linkedin.com/in/kevinmeinon" target="_blank"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/></a>
...
Backend engineer with 7+ years of experience building production-grade APIs, microservices, and data pipelines. Specializing in Python, CI/CD automation, and cloud-native deployments. Currently expanding into AI/ML engineering — RAG systems and LLM integrations.

Based in Frankfurt, Germany. Open to remote opportunities.
...
### Backend Engineering
- Scalable APIs (**FastAPI, Django, Flask**)
- Asynchronous task processing (**Celery**)
- Database design & optimization (SQL/NoSQL)
- Serverless architectures (AWS Lambda, API Gateway)

### CI/CD & Cloud
- Multi-stage CI/CD pipelines (**GitHub Actions**)
- Containerization (**Docker** – multi-stage builds, DevContainers)
- Infrastructure as Code (**Terraform**) for Azure & AWS
- Secure Data Pipelines (Microsoft Fabric, Azure Storage)

### AI Engineering
- LLM API integrations (OpenAI, Claude, Stability AI)
...
[📧 kevin@meinon.de](mailto:kevin@meinon.de) · [LinkedIn](https://www.linkedin.com/in/kevinmeinon)
